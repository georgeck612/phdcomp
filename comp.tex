...
\begin{frame}{Data is Big}
  ...
  \begin{figure}
    \begin{center}
      \includegraphics[width=.7\textwidth]{brains.png}\cite{mripics}
    \end{center}
  \end{figure}
  }
  \only<2>{
    \begin{figure}
      \begin{center}
        \includegraphics[width=.8\textwidth]{weatherstation.png}\cite{climatepic}
      \end{center}
    \end{figure}
  }
\end{frame}
...
\begin{frame}{Filtering}
  \only<1>{\begin{figure}
    \begin{center}
      \vspace*{-4.25cm}\includegraphics[width=1\textwidth]{filteredposterdata.png}
    \end{center}
  \end{figure}
